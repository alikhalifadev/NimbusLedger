...
const contractABI = require("../artifacts/contracts/Nimbusledger.sol/Nimbusledger.json").abi;

program
    .name("nimbusledger-cli")
    .description("CLI tool for Nimbusledger smart contract")
    .version("1.0.0");
